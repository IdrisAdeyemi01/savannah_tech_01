...
import 'package:savannah_tech01/src/review_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      /// To view the [ReviewScreen], uncomment the line below
      // home: ReviewsScreen(reviews),

      /// To view the [LoginScreen], uncomment the line below
